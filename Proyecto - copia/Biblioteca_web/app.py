...
from Proyecto import Libro, Usuario, Prestamo, actualizar_libro, eliminar_libro, crear_tablas, prestar_libro, devolver_libro, actualizar_estructura_base_datos, verificar_consistencia_libros
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if not all([documento_usuario, id_libro, dias]):
                ...
                libros = Libro.obtener_todos()
                generos, total_generos = calcular_estadisticas_generos(prestamos, libros)
                return render_template("prestamos.html", prestamos=prestamos, usuarios=usuarios, libros=libros, generos=generos, total_generos=total_generos)
